...
sv_ts_stalker_refractamount = CreateConVar( "sv_ts_stalker_refractamount", "0.0005", { FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_SERVER_CAN_EXECUTE }, "Controls the starting refraction of the stalker. (def 0.0005)" )
